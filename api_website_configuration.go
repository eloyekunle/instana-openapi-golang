 ...
 * @param websiteId
*/
func (a *WebsiteConfigurationApiService) Delete(ctx _context.Context, websiteId string) (*_nethttp.Response, error) {
	var (
...
@return []Website
*/
func (a *WebsiteConfigurationApiService) Get(ctx _context.Context) ([]Website, *_nethttp.Response, error) {
	var (
