 ...
 * @param id
*/
func (a *EventSettingsApiService) DisableWebsiteAlertConfig(ctx _context.Context, id string) (*_nethttp.Response, error) {
	var (
 ...
 * @param id
*/
func (a *EventSettingsApiService) EnableWebsiteAlertConfig(ctx _context.Context, id string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
